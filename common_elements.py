...
def common(list1, list2):
    ...
    intersection_set = set()  # Use set to reduce lookup from O(n) to O(1)
    set2 = frozenset(list2)

    for l1_item in list1:
        if (l1_item in set2) and (l1_item not in intersection_set):
            result.append(l1_item)
            intersection_set.add(l1_item)
